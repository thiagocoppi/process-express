...
{
    public class ProcessExpressStartup : Startup
    {
        public ProcessExpressStartup(IConfiguration configuration) : base (configuration)
        {
        ...
        public override void ConfigureServices(IServiceCollection services)
        {
            ...
            var key = Encoding.ASCII.GetBytes(Configuration.GetValue<string>("ApplicationSecret"));
